                            ...
                            <div class="col-lg-8 col-md-8 col-sm-9">
                                <nav id="desktop-nav">
                                   <ul>
                                        ...
                                        <li><a href="#">Researcher Service</a>
                                            <ul>
                                                <li><a href="researcher.jsp">Create Researchers</a></li>
                    ...
                    <form method="POST" enctype="multipart/form-data">     
					   ...
					   <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                               ...
                               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label" for="first-name">Account Number:</label>
                                    <input type="text" id="pass" class="form-control" name="Fblink" value="" required>
                                </div>
                            </div> 
                               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label class="control-label">Your Research Details</label>
