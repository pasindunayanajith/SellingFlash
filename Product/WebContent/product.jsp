...
<!-- Registration Form  -->
        <div class="registration-page-area bg-secondary">
            <div class="container">
                <h2 class="sidebar-title">Add Product </h2>
         ...
         <form id="formProduct" name="formProduct">
					...
					Product Description(Your More Research Details Links,ContactNumber  include):<textarea id="productDescription" name="productDescription" class="form-control form-control-sm" rows="4" cols="50"></textarea> <br>
